  ...
  <q-page padding>
    <div class="q-pa-md" style="max-width: 1200px; margin: 0 auto;">
      ...
      <div class="row items-center q-mb-md">
        <div class="col">
          <h5 class="q-my-none">{{ $t('managementCompanies.create') }}</h5>
        </div>
        <div class="col-auto">
          <q-btn
            flat
...
export default defineComponent({
  name: 'CreateManagementCompanyPage',
  ...
  setup() {
    ...
    const onSubmit = async () => {
      ...
      try {
        await managementCompaniesAPI.create(form.value);
        
        $q.notify({
          message: t('managementCompanies.createSuccess'),
          color: 'positive',
          icon: 'check'
        });
